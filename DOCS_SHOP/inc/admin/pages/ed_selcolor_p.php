...
<TITLE><?php echo $lang['select_color']; ?></TITLE>
<STYLE TYPE="text/css">
...
<P>
<LABEL FOR=SelColor><?php echo $lang['color']; ?>:</LABEL>
<INPUT TYPE=TEXT SIZE=20 ID=SelColor>
<br>
<SPAN ID=RGB>&nbsp;</SPAN>
<P>
<BUTTON ID=Ok TYPE=SUBMIT>OK</BUTTON>&nbsp;&nbsp;&nbsp;<BUTTON ONCLICK="window.close();"><?php echo $lang['cancel']; ?></BUTTON>
</BODY>
