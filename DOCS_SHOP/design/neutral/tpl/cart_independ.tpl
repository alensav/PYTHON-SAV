...
<link id="main_css" href="{design_url}styles.css" rel="stylesheet" type="text/css">
{tunable_css_link}
{metatags}
</head>
...
<tr class="{def_class}">
 ...
 <td class="alignCenter"><input type="text" name="product_quantity[{product_id}][{variant_id}]" size="3" value="{def_product_quantity}"></td>
 <td><a href="cart.php?act=del&amp;product={product_id}&amp;variant={variant_id}&amp;independ=1" onclick="return delq();"><img src="{design_url}img/del.gif" alt="{lang.delete}" class="imgst"></a></td>
