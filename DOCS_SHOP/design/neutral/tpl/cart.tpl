...
<div class="addReport">{additional_report}</div>
 ...
 <input type="hidden" name="act" value="recalculate">
  ...
  <tr class="{def_class}">
   ...
   <td><a href="cart.php?act=del&amp;product={product_id}&amp;variant={variant_id}" onclick="return delq();"><img src="{design_url}img/del.gif" alt="{lang.delete}" title="{lang.delete}" class="imgst"></a></td>
